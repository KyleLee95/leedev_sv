<script lang="ts">
	...
	import { buttonVariants, Button } from './ui/button/index.js';
...
<Sheet.Root bind:open>
	<Sheet.Trigger
		class="mr-2 px-0 text-base hover:bg-transparent focus-visible:bg-transparent focus-visible:ring-0
focus-visible:ring-offset-0 md:hidden"
	...
	<Sheet.Content side="left" class="pr-0">
		<MobileLink href="/" title="test" bind:open>
